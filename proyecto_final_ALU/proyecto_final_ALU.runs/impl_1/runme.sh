...
HD_PWD='C:/Users/Jorge Vasquez/Desktop/ClasesMaestria/CLP/ALU/proyecto_final_ALU/proyecto_final_ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_VIO.tcl -notrace
