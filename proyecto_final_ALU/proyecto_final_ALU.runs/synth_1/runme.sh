...
HD_PWD='C:/Users/Jorge Vasquez/Desktop/ClasesMaestria/CLP/ALU/proyecto_final_ALU/proyecto_final_ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_VIO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_VIO.tcl
